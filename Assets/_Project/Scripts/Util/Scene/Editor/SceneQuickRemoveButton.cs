...
namespace _Project.Scripts.Util.Scene.Editor
{
    ...
    public static class HierarchySceneHeaderCloseButton
    {
        ...
        private static void DrawCloseButton(UnityEngine.SceneManagement.Scene scene, Rect rowRect)
        {
...
// Normal close only when clicking the red dot
        ...
        private static bool QuickSaveThenClose(UnityEngine.SceneManagement.Scene scene)
        {
